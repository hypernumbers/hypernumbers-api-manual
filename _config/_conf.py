# -*- coding: utf-8 -*-
#
# WordPress And Vixo documentation build configuration file, created by
...
project = u'WordPress And Vixo'
copyright = u'2013, Hypernumbers Ltd (trading as vixo.com)'
...
htmlhelp_basename = 'WordPressAndVixodoc'
...
latex_documents = [
  ('index', 'WordPressAndVixo.tex', u'WordPress And Vixo',
